...
export default function CourseTopic() {
  ...
  const name = useLocation().state?.ChapterName;
  ...
  const allSubjects = {
        ...
        Chapter1: ["Rolls_theorem", "Chachys_theorem", "xyz_theorem", "abc_theorem"],
        Chapter2: ["lkm_theorem", "devivations", "integrations", "calculations"],
     
        Chapter3: ["Normalization", "constraints", "rules", "sql queries"],
        Chapter4: ["lkm theorem", "plsql", "oops", "deadlock"],
